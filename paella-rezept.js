...
let ingredients = ['Meeresfrüchte', 'Paella-Reis', 'Zwiebel(n)', 'Knoblauchzehen', 'Paprika', 'grüne Bohnen', 'Olivenöl',
    '	Brühe', 'Meersalz', ' Pfeffer', 'Zitrone'];

let units = ['g', 'g', '', '', '', 'g', 'El', 'ml', '', '', ''];

let amounts = [400, 200, 1, 2, 1, 100, 6, 700, '', '', 1];
